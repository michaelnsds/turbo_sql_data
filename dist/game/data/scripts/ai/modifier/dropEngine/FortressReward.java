...
{
	private static final int KE = Config.REWARD_ID_FORTRESS;
	...
	private static final int[] ARCHER_DROP    = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	...
	private static final int[] ARCHCAP_DROP   = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] CGUARD_DROP    = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	...
	private static final int[] DECORATED_DROP = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	...
	private static final int[] DGSERG_DROP2   = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	private static final int[] GENERAL        = { 36066, 36349, 35959, 35997, 36387, 35790, 36204, 36242, 36280, 35890, 35721 };
	private static final int[] GENERAL_DROP   = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] GUARD_DROP     = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	...
	private static final int[] GUARDCAP_DROP  = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] HEALER_DROP    = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	private static final int[] MINISTER       = { 36205, 36243, 36281, 35891, 35722, 36067, 36350, 35960, 35998, 36388, 35791 };
	private static final int[] MINISTER_DROP  = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] REBELCOM_DROP  = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] REBELPRIV_DROP = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	private static final int[] SGOLEM         = { 35781, 36233, 36271, 36195, 35881, 35712, 36057, 36095, 36340, 35950, 35988, 36378 };
	private static final int[] SGOLEM_DROP    = { 4, 6, Config.REWARD_CHANCE };
	private static final int[] SBOX1          = { 35665 };
	private static final int[] SBOX_DROP1     = { 40, 80, Config.REWARD_CHANCE };
	private static final int[] SBOX2          = { 35697, };
	private static final int[] SBOX_DROP2     = { 80, 160, Config.REWARD_CHANCE };
	private static final int[] SBOX3          = { 35803 };
	private static final int[] SBOX_DROP3     = { 200, 400, Config.REWARD_CHANCE };
	private static final int[] SBOX4          = { 35834 };
	private static final int[] SBOX_DROP4     = { 240, 480, Config.REWARD_CHANCE };
	private static final int[] SBOX5          = { 35734 };
	private static final int[] SBOX_DROP5     = { 120, 240, Config.REWARD_CHANCE };
	private static final int[] SBOX6          = { 35766 };
	private static final int[] SBOX_DROP6     = { 160, 320, Config.REWARD_CHANCE };
	...
	private static final int[] SUPPORT_DROP   = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] WIZARD_DROP    = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	// @formatter:on
